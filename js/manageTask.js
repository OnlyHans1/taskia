document.addEventListener('DOMContentLoaded', () => {
    ...
    function capitalizeFirstChart(str){
        if(!str) return str;
    ...
    function displayAllTasks(tasks = existingTasks){
        if (existingTasks.length === 0){
            ...
            console.log('Tidak ada tasks tersedia')
        } else {
                            ...
                            <div class="task-card flex flex-col gap-5">
                                <div class="flex gap-3 items-center">
                                    ...
                                    <div class="flex flex-col">
                                        <p class="font-bold text-lg leading-[27px]">${capitalizeFirstChart(task.taskName)}</p>
